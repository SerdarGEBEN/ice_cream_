...
test("Miktar, başlık, fotoğraf gelen propa göre ekrana basılır", () => {
  ...
  // getBy elementi bulamazsa hata fırlatır bu yüzden sadece
  //"x" yazı içeriğine sahip element ekranda mı kontrolü yapmak
  // istiyorsak getByText ile elementi çağırmak yeterlidir daha
...
test("Butonlara tıklanınca fonksiyonlar doğru parametreler ile çalışır", async () => {
  ...
  // prop olarak göndeirlecek fonksiyonları test ediceksek jest aracılığı
  //(mock) ile test edilebilir fonksiyonlar oluştur
